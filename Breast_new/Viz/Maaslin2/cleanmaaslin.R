## =========================================================
## MaAsLin2 Volcano Plot (Tumor vs NAT, 5% filter)
## =========================================================
...
data <- read.csv("raw10pct.csv", header = TRUE)
...
volcano_maaslin <- ggplot(plot_data,
  ...
  labs(
    title = "MaAsLin2 Volcano Plot, Raw : Tumor vs NAT (10% filter)",
...
# Save plot
ggsave("vpraw10pct_maaslin.png", plot = volcano_maaslin,
       width = 10, height = 8, dpi = 300)
ggsave("vpraw10pct_maaslin.pdf", plot = volcano_maaslin,
       width = 10, height = 8)
