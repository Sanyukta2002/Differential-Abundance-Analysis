setwd("C:/Users/sanyu/OneDrive/Desktop/Lung_new/Viz/Ancom")
library(ggplot2)
library(ggrepel)
library(dplyr)
...
volcano_ancom <- ggplot(plot_data,
  ...
  labs(
    title = "ANCOM-BC2 Volcano Plot, Lung Imputed : Tumor vs NAT (5% filter)",
...
# Save plot
ggsave("vpimp5pct_ancom.png", plot = volcano_ancom,
       width = 10, height = 8, dpi = 300)
ggsave("vpimp5pct_ancom.pdf", plot = volcano_ancom,
       width = 10, height = 8)
