setwd("C:/Users/sanyu/OneDrive/Desktop/Lung_new/Viz/Aldex2")
library(ggplot2)
library(ggrepel)
library(dplyr)
...
volcano_aldex <- ggplot(plot_data,
  ...
  labs(
    title = "ALDEx2 Volcano Plot,Lung Imputed: Tumor vs NAT (5% filter)",
...
# Save plot
ggsave("vpimp5pct_aldex.png", plot = volcano_aldex,
       width = 10, height = 8, dpi = 300)
ggsave("vpimp5pct_aldex.pdf", plot = volcano_aldex,
       width = 10, height = 8)
