setwd("C:/Users/sanyu/OneDrive/Desktop/Lung_new/Viz/Maaslin2")
library(ggplot2)
library(ggrepel)
library(dplyr)
...
volcano_maaslin <- ggplot(plot_data,
  ...
  labs(
    title = "MaAsLin2 Volcano Plot, Lung Raw : Tumor vs NAT (5% filter)",
...
# Save plot
ggsave("vpraw5pct_maaslin.png", plot = volcano_maaslin,
       width = 10, height = 8, dpi = 300)
ggsave("vpraw5pct_maaslin.pdf", plot = volcano_maaslin,
       width = 10, height = 8)
