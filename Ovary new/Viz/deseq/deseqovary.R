setwd("C:/Users/sanyu/OneDrive/Desktop/Ovary new/Viz/deseq")
library(ggplot2)
library(ggrepel)
library(dplyr)
...
volcano_deseq <- ggplot(plot_data,
  ...
  labs(
    title = "DESeq2 Volcano Plot, Ovary Imputed: Tumor vs NAT (5% filter)",
...
# Save plot
ggsave("Vpimp5pct.png", plot = volcano_deseq,
       width = 10, height = 8, dpi = 300)
ggsave("Vpimp5pct.pdf", plot = volcano_deseq,
       width = 10, height = 8)
